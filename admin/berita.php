          ...
          <div class="card-body">
            <div class="row">
              <div class="col-xl-6 col-12">
                <h5>Panel Berita</h5>
                <div class="row">
                  <form action="beritaprosess.php" method="post">
                    <label>Judul</label>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                    <input type="text" class="form-control" name="link" placeholder="Link Berita">
                    </div>
              ...
              <div class="col-xl-6 col-12 mt-5 mt-xl-0">
                <div class="row mt-3">
                  ...
                  <a href="<?= $data['link'] ?>" class="col-12 mb-3 text-decoration-none" target="_blank">
                    ...
                    <a href="hapusberita.php?id=<?= $data['id'] ?>" class="badge bg-danger mx-2">Hapus</a>
